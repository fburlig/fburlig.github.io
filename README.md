...
Quarto site (same template as edrub.in), rendered by GitHub Actions on every push to `main` and published from the `gh-pages` branch. Nothing to install locally unless you want to preview (`quarto preview`).
